...
public:
  ...
  void readRawByte(BlackT::TStream& src, int byteAddr, int length);
  void readRawWord(BlackT::TStream& src, int wordAddr, int length);
  void writeRawByte(BlackT::TStream& dst, int byteAddr, int length) const;
  void writeRawWord(BlackT::TStream& dst, int wordAddr, int length) const;
