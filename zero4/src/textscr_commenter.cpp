...
//const int tableBase = 0xE90C - 0xE000;
//const int numOps = 0x20 - 1;
//const int tableBase = 0xE94C - 0xE000;
const int tableBase = 0xF4F0 - 0xE000;
const int numOps = 0x60 - 0;
...
//    char c; cin >> c;
    ...
    if (findIt != textscrAddrToOpMap.end()) {
      ...
      fileofs << endl << "; gamescript op 0x" << as2bHex(opNum) << endl << endl;
      fileofs << line << endl;
    }
    else {
      fileofs << line << endl;
